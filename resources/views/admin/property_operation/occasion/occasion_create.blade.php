        ...
        <div class="col-lg-12">
            ...
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-edit">Add Occasion Item</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form method="POST" action="{{ route('user.occasion.create.post') }}" enctype="multipart/form-data">
                    @csrf
                  ...
                  @enderror
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="ready_time" type="text" class="form-control @error('ready_time') is-invalid @enderror" id="ready_time" value="{{ old('ready_time') }}" placeholder="Duration">
                        @error('ready_time')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror 
                      </div>
